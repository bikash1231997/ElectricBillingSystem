...
import javax.swing.*;
import java.sql.*;
public class  ViewMeter extends JInternalFrame  
{
   JTable table;
   JScrollPane jsp;
   ...
   public ViewMeter(Connection con)
   {
     super ("METER REPORT", false, true, false, true);
	 setSize (500, 550);
     String s[][]=new String[50][6]; 
     String colheads[]={"MeterId","MachineId","CustomerId","MeterStatus","MeterPrevReading","MeterPresReading"}; 
